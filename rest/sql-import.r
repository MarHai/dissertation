...
dfArticle$dCreate <- as.POSIXct(dfArticle$dCreate, origin='1970-01-01', tz='GMT')
...
dfHighlight$dCreate <- as.POSIXct(dfHighlight$dCreate, origin='1970-01-01', tz='GMT')
...
dfHomepage$dCreate <- as.POSIXct(dfHomepage$dCreate, origin='1970-01-01', tz='GMT')

dfUpdate <- read.csv('update.csv', encoding='UTF-8')
dfUpdate$nArtId <- factor(dfUpdate$nArtId, dfArticle$nArtId, dfArticle$sUrl)
dfUpdate$dCreate <- as.POSIXct(dfUpdate$dCreate, origin='1970-01-01', tz='GMT')
...
dfPost$dCreate <- as.POSIXct(dfPost$dCreate, origin='1970-01-01', tz='GMT')
...
dfPopularity$dCreate <- as.POSIXct(dfPopularity$dCreate, origin='1970-01-01', tz='GMT')

dfPing <- read.csv('ping.csv', encoding='UTF-8')
dfPing$dCreate <- as.POSIXct(dfPing$dCreate, origin='1970-01-01', tz='GMT')
aggregate(dfPing$nTime, list(dfPing$sSource), summary)
